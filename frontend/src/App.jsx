...
// Put your image here: src/assets/sitebg.png (or .jpg/.avif — update import)
...
export default function App() {
  ...
  return (
    <div className="app" style={{ "--heroBg": `url(${heroBg})` }}>
      ...
      {/* HERO (NO sitebg here — only hero background) */}
      ...
      {/* ✅ SITE BACKGROUND STARTS HERE (About → Contact only) */}
      <div className="siteBgWrap" style={{ "--siteBg": `url(${siteBg})` }}>
        ...
        <section className="section" id="about">
          <div className="container">
            ...
            <div className="panel">
              <p className="text">
                I’m a software engineering student who enjoys turning ideas into real, working systems — not just demos. I like building projects where the UI, backend logic, and database all connect properly, because that’s where software starts feeling “real.” I care about structure, readability, and the small details that make an app smooth to use.
              </p>
              <p className="text">
                I’m especially interested in full-stack development and backend engineering. I enjoy designing REST APIs, organizing clean folder structures, and building features step-by-step so the codebase stays easy to maintain. I also like debugging and performance tuning — when something breaks, I want to understand why, not just patch it.
              </p>
              <p className="text">
                Outside of coursework, I spend time sharpening my skills by building portfolio projects, reviewing best practices, and learning how real development teams work (version control, clean commits, documentation, and incremental improvements). My goal is to keep building stronger end-to-end projects that feel production-ready and reflect real-world development standards.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid2">
              <div className="card projectCard">
                ...
                <div className="cardBody">
                  ...
                  <p className="text">
                    It integrates backend APIs with database functionality and a structured front-end interface to
                    manage event data and user actions.
                  </p>
              ...
              <div className="card projectCard">
                ...
                <div className="cardBody">
                  ...
                  <p className="text">Designed and developed a front-end website themed around a Formula 1 racing team, with a strong focus on layout, branding, and modern UI structure. This project helped me practice building a multi-section website that feels like a real team landing page — including a home section, team information, media-style content, and navigation that connects everything smoothly.</p>
                  <p className="text">I worked on creating consistent spacing, typography, and visual hierarchy so that the site looks clean and professional. I also focused on responsive design, ensuring the layout adapts well across different screen sizes. This project improved my understanding of web structure, CSS styling, and how to design pages that feel cohesive instead of “random sections.”</p>
                  <div className="tagRow">
              ...
              <div className="card projectCard">
                ...
                <div className="cardBody">
                  ...
                  <p className="text">Built a promotional landing page concept for a fictional PlayStation 6 launch, designed to look like a real product marketing page. The goal was to create a modern UI/UX feel using strong hero design, product-focused sections, and a layout that guides the viewer smoothly down the page.</p>
                  <p className="text">I focused on clean styling, section organization, and creating a strong “product identity” using typography, spacing, and consistent visuals. This project helped me improve my ability to design landing pages that look polished, not just functional. It also strengthened my front-end fundamentals and improved how I approach UI decisions (readability, spacing, and user flow).</p>
                  <div className="tagRow">
                    <span className="tag">HTML</span>
                    <span className="tag">CSS</span>
                    <span className="tag">JavaScript</span>
          ...
          <div className="container">
            ...
            <div className="grid2">
              <div className="card eduCard">
                ...
                <p className="text">
                  At RIT Dubai, I’m building strong foundations in software engineering, databases, web development, and system design. My coursework and projects have helped me strengthen problem-solving, programming fundamentals, and practical development skills — especially through assignments that involve building complete applications. </p>

                <p className="text">I’m also learning how to approach engineering work with structure: planning before coding, keeping code readable, and improving designs through iteration. Alongside academics, I actively build portfolio projects to apply what I learn in a more realistic way.
                </p>
                <div className="tagRow">
              ...
              <div className="card eduCard">
                ...
                <p className="text">
                  During high school at Delhi Private School, I developed consistent academic habits, communication skills, and discipline — which became the foundation for my current growth in technology and engineering. My interest in problem-solving and computers continued to grow over time, and I began moving toward software development as a serious career path. </p>
                <p className="text">
                  This period helped me strengthen my ability to learn consistently, manage deadlines, and communicate clearly — skills that now support my university projects and internship work.
                </p>
                <div className="tagRow">
            ...
            <div className="grid2">
              <div className="mediaCard tallMedia">
                ...
                <div className="mediaCaption">
                  ...
                  <div className="mediaText">
                    Completed the AWS APAC Solutions Architecture program on Forage, where I learned how to think about cloud systems from an architectural perspective. The experience focused on designing scalable and reliable solutions, considering factors like availability, security, and performance.</div>

                  <div className="mediaText">Through the program, I practiced designing a hosting architecture that supports growth, handles traffic efficiently, and follows good cloud practices. It helped me build a stronger understanding of how modern applications are deployed and what decisions matter when building cloud-ready systems.
                  </div>
                </div>
              </div>
              ...
              <div className="mediaCard tallMedia">
                ...
                <div className="mediaCaption">
                  ...
                  <div className="mediaText">I focused on learning how to communicate clearly with AI tools, how to break down problems, and how to apply prompting to real tasks like writing, brainstorming, and problem-solving. This certification improved my ability to use AI productively while staying intentional about the output quality.
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid2 contactGrid">
              ...
              <div className="formCard">
                ...
                <form
                  onSubmit={(e) => {
                    e.preventDefault();
                    alert("Form UI ready. Backend can be connected next.");
                  }}
                >
                  ...
                  <textarea className="textarea" placeholder="Your Message" rows={7} />
      ...
      {/* ✅ FOOTER OUTSIDE site background */}
